...
const CellEditorComponent: React.FC<CellEditorProps> = ({
  ...
  return (
    <div
      ref={cellRef}
      className="relative group h-full min-h-[48px] px-4 py-3 flex items-center justify-between overflow-visible"
    ...
    >
      ...
      {!readOnly && externalShowColorPicker && (
        <button
          className="opacity-0 group-hover:opacity-100 focus:opacity-100 transition-opacity flex-shrink-0 p-1 hover:bg-gray-200 dark:hover:bg-gray-700 rounded z-20"
          onClick={(e) => {
            e.stopPropagation();
