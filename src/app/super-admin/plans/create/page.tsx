        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Optionally inherit features from an existing plan</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          {/* Custom Tables & Content Limits */}
          <Card>
            <CardHeader>
              <CardTitle>Customizable Tables & Content</CardTitle>
              <CardDescription>Pro features for tables, files, documents, and messages</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div className="space-y-1">
