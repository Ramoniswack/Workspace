...
import { Layers, UserPlus, Eye, EyeOff, ArrowRight, Loader2 } from 'lucide-react';
        ...
        <div className="bg-white dark:bg-[#1a1a1a] rounded-xl shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-200 dark:border-slate-800 p-5 sm:p-6">
          ...
          <div className="text-center mb-4">
            ...
            <div className="inline-flex items-center justify-center size-10 bg-[#135bec]/10 rounded-full mb-2">
              <UserPlus className="text-[#135bec] size-5" />
            </div>
            <h1 className="text-slate-900 dark:text-slate-100 text-lg font-bold">Create account</h1>
            <p className="text-slate-500 dark:text-slate-400 mt-0.5 text-xs">Start managing tasks today</p>
          </div>
          ...
          <div className="mt-4 pt-4 border-t border-slate-100 dark:border-slate-800 text-center">
            <p className="text-xs text-slate-600 dark:text-slate-400">
              ...
              <Link href="/login" className="text-[#135bec] font-bold hover:underline">
                Sign In
              </Link>
            </p>
          </div>
